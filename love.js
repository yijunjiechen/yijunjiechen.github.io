window.onload = function() {
        ...
        function ClickFrontShow() {
            //定义所需文字和颜色
            this.fron = ['❤升职', '❤加薪', '❤旅游', '❤充电', '❤暴富', '❤奋斗', '❤幸福', '❤梦想', '❤学习', '❤买房', '❤买车', '❤结婚'];
        ...
        ClickFrontShow.prototype.createFront = function (classname) {
            ...
            //设置样式
            let cssText = "position:absolute; width: 60px; height: 20px; cursor: default; transform: translate(-50%,-50%); font-weight: bold; opacity: 1; z-index: 1000; transition: 1s;";
            //随机字体和颜色
