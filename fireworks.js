...
function createCircle(e, t) {
    var a = {};
    return a.x = e, a.y = t, a.color = "#F00", a.radius = 0.1, a.alpha = 0.5, a.lineWidth = 0, a.draw = function () {
        ctx.globalAlpha = a.alpha, ctx.beginPath(), ctx.arc(a.x, a.y, a.radius, 0, 0.5 * Math.PI, !0), ctx.lineWidth =
...
function animateParticules(e, t) {
    ...
    anime.timeline().add({
        ...
        radius: 0.1,
		duration: anime.random(1200, 1300),
        /*duration: anime.random(1200, 1800),*/
        easing: "easeOutExpo",
        update: renderParticule
    }).add({
        targets: a,
        radius: anime.random(60, 80),
        lineWidth: 0,
        alpha: {
            value: 0,
            easing: "linear",
